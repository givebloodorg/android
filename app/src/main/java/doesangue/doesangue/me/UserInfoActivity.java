...
public class UserInfoActivity extends AppCompatActivity {
    ...
    public void getJsonAuthenticatedUser() {
        ...
        JsonObjectRequest jSonRequest = new JsonObjectRequest(Request.Method.GET, server_url, null, new Response.Listener<JSONObject>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(getApplicationContext().getApplicationContext(), "Could not load authenticated user info", Toast.LENGTH_SHORT).show();
